class MotionTracker
	constructor: ->
		...
		if window.DeviceOrientationEvent
            ...
            window.addEventListener 'deviceorientation', @tilt.bind(this), false
            ...
            window.addEventListener 'MozOrientation', @foxTilt.bind(this), false
        else
        if window.DeviceMotionEvent
        	# We can get infomation on acceleration and rotation rate if this exists
        	window.addEventListener 'devicemotion', @accel.bind(this), false
        else
